    ...
    },
    {
      label: (
        <Img
          ...
          src="images/img_fluentvehiclecar16filled_blue_a200.svg"
          alt="fluentvehicleca"
        />
      ),
    },
      ...
      <div className="bg-gray-50 flex flex-col font-outfit items-center justify-end mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-5 items-start justify-evenly w-full">
          ...
          <div className="flex flex-1 flex-col gap-[19px] items-center justify-start md:px-5 w-full">
            ...
            <div className="flex md:flex-col flex-row gap-3.5 items-center justify-start w-[97%] md:w-full">
              <div className="flex flex-col items-center justify-start w-[63%] md:w-full">
                <div className="gap-3.5 md:gap-5 grid sm:grid-cols-1 md:grid-cols-2 grid-cols-3 justify-center min-h-[auto] w-full">
                  <div className="bg-white-A700 flex flex-1 flex-col gap-[15px] items-start justify-start p-2.5 rounded-[10px] w-full">
                    <Img
                  ...
                  <div className="bg-white-A700 flex flex-1 flex-col gap-[15px] items-start justify-start p-2.5 rounded-[10px] w-full">
                    <Img
                      className="h-[203px] md:h-auto md:ml-[0] ml-[3px] object-cover rounded-[10px] w-[98%] sm:w-full"
                      src="images/img_rectangle18_203x234.png"
                      alt="rectangleEighteen"
                    />
                    <div className="flex flex-col gap-1.5 items-start justify-start mb-2.5 md:ml-[0] ml-[3px]">
                      <Text
              ...
              <div className="flex flex-col gap-[11px] items-center justify-start w-[37%] md:w-full">
                <div
